...
public class LibrarianController {
    ...
    public ResponseEntity<String> updateAuthor(@Valid @PathVariable Long id, @RequestBody LibrarianRequest request) {
    ...
    @GetMapping("/get-all")
    public ResponseEntity<List<LibrarianResponse>> getAllAuthors() {
    ...
    public ResponseEntity<LibrarianResponse> getAuthorById(@PathVariable Long id) {
